  ...
  return (
    <>
      ...
      {showTutorial && mounted && (() => {
        const steps = [
          {
            title: lang === "tr" ? "Hoş geldin, Savaşçı! 🎮" : "Welcome, Warrior! 🎮",
            body: lang === "tr"
              ? "Düşman dalgalarına karşı hayatta kal ve güçlen!"
              : "Survive enemy waves and grow stronger!",
            extra: lang === "tr" ? "Hazır mısın? Kontrolleri öğrenelim!" : "Ready? Let's learn the controls!",
          },
          {
            title: lang === "tr" ? "Hareket 🕹️" : "Movement 🕹️",
            body: isMobileDevice
              ? (lang === "tr" ? "Sol joystick: Hareket\nSağ alan: Kamera\nButonlar: Zıpla & Kayma" : "Left joystick: Move\nRight area: Camera\nButtons: Jump & Slide")
              : (lang === "tr" ? "WASD: Hareket\nMouse: Kamera\nSpace: Zıpla\nShift: Kayma" : "WASD: Move\nMouse: Camera\nSpace: Jump\nShift: Slide"),
            extra: null,
          },
          {
            title: lang === "tr" ? "Silahlar & Seviye ⚔️" : "Weapons & Leveling ⚔️",
            body: lang === "tr"
              ? "Düşmanları öldür → XP topla → Seviye atla → Yeni silah seç!"
              : "Kill enemies → Collect XP → Level up → Pick new weapons!",
            extra: "🗡️ ⚔️ 🏹 🔮 ❄️ ⚡ 🔥",
          },
          {
            title: lang === "tr" ? "Boss'lar & Evrimler 🐉" : "Bosses & Evolutions 🐉",
            body: lang === "tr"
              ? "Her 5 dakikada bir boss gelir. Silahlarını seviye 5'e çıkar → evrimleştir!"
              : "A boss comes every 5 minutes. Upgrade weapons to level 5 → evolve them!",
            extra: "⛰️ 🔥 👿",
          },
          {
            title: lang === "tr" ? "Hazır mısın? 💪" : "Ready? 💪",
            body: lang === "tr"
              ? "İyi şanslar! İlk hedef: 5 dakika hayatta kal."
              : "Good luck! First goal: survive 5 minutes.",
            extra: null,
          },
        ];
        ...
        return (
          <div style={{
            ...
            >
              {lang === "tr" ? "Atla ⏭️" : "Skip ⏭️"}
            </button>

            <div style={{
              maxWidth: 440, width: "90%", padding: "40px 32px",
              background: "linear-gradient(135deg, rgba(20,10,30,0.95), rgba(30,15,40,0.95))",
              ...
              <h2 style={{
                fontSize: 28, fontWeight: 900, margin: "0 0 16px",
              ...
              <p style={{
                ...
                lineHeight: 1.6, whiteSpace: "pre-line", margin: "0 0 12px",
              }}>{step.body}</p>

              {step.extra && (
                <p style={{ fontSize: 24, margin: "12px 0", letterSpacing: 4 }}>{step.extra}</p>
              )}
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: 8, margin: "24px 0 20px" }}>
                {steps.map((_, i) => (
                  <div key={i} style={{
                    ...
                    background: i === tutorialStep ? "#ff6b35" : "rgba(255,255,255,0.2)",
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: 12 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: isLast ? "linear-gradient(135deg, #ff6b35, #ff8c42)" : "linear-gradient(135deg, #ff6b35, #ff8c42)",
                    color: "white", fontWeight: 700, fontSize: 16, cursor: "pointer",
                    boxShadow: "0 4px 15px rgba(255,107,53,0.3)",
                  }}
                >
                  {isLast ? (lang === "tr" ? "⚔️ Başla!" : "⚔️ Start!") : (lang === "tr" ? "İleri →" : "Next →")}
                </button>
              </div>
            </div>
          </div>
